 ...
 * 法務局(表示・登録、編集、削除)
 */
class AdminConfigLegalPlaceController extends Controller
{   
    /**
     *  一覧(表示)
     *
     ...
     * @return
     */
    public function adminConfigLegalPlaceInit(Request $request){   
        ...
        return view('admin.adminLegalPlace' ,$legal_place_info);
    }
     ...
     * @return
     */
    public function adminConfigLegalPlaceNewInit(Request $request){   
        Log::debug('start:' .__FUNCTION__);
        ...
        Log::debug('end:' .__FUNCTION__);
        return view('admin.adminLegalPlaceEdit' ,compact('legal_place_list'));
    }
     ...
     * @return
     */
    public function adminConfigLegalPlaceEditInit(Request $request){   
        Log::debug('start:' .__FUNCTION__);
