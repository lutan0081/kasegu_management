...
namespace App\Http\Controllers\Back\App;
...
{   
     ...
     */
    public function backAppInit(Request $request)
    {   
        ...
        return view('back.backApp' ,$app_list,compact('contract_progress'));
    }
     ...
     */
    public function backAppEditEntry(Request $request){
     ...
     * @return void
     */
    public function backAppEditInit(Request $request){
