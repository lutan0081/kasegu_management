...
<!-- ヘッダー -->
<script src="{{ asset('front/js/front_header.js') }}"></script>

<!-- fadeUpContinue -->
<script src="{{ asset('fadeUpContinue/js/fadeUpContinue.js') }}"></script>

<!-- fadeAnimematon -->
<script src="{{ asset('fadeAnimematon/js/fadeAnimematon.js') }}"></script>
