...
<link rel="apple-touch-icon" href="./icon/kasegu_icon_64.ico">
...
<!-- ヘッダー -->
<link rel="stylesheet" href="{{ asset('back/css/back_header.css') }}">

<!-- サイドバー -->
<link rel="stylesheet" href="{{ asset('back/css/back_sidebar.css') }}">

<!-- url発行 -->
<link rel="stylesheet" href="{{ asset('back/css/back_url.css') }}">
