        ...
        <div class="tab-content" id="nav-tabContent">
            ...
            <div class="tab-pane fade" id="nav-trade" role="tabpanel" aria-labelledby="nav-trade-tab">
                <div class="row row-cols-2">
                    ...
                    <div class="col-6 col-md-12 col-lg-3 mt-3">
                        ...
                        <div class="trade-tab invalid-feedback" id ="contract_start_date_error">
                            入居予定日は必須です。
                        </div>
                    </div>
                    ...
                    <div class="col-6 col-md-6 col-lg-3 mt-3">
                        ...
                        <input type="number" class="form-control" name="pet_bleed" id="pet_bleed" value="{{ Common::zeroToSpaceForContract($app_list->entry_contract_name, $app_list->pet_bleed) }}" placeholder="例：2" style="text-align:right" required> 
                    ...
                    <div class="col-6 col-md-6 col-lg-3 mt-3">
                        ...
                        <input type="number" class="form-control" name="bicycle_number" id="bicycle_number" value="{{ Common::zeroToSpaceForContract($app_list->entry_contract_name, $app_list->bicycle_number) }}" placeholder="例：1" style="text-align:right" required>
                    ...
                    <div class="col-6 col-md-6 col-lg-3 mt-3">
                        ...
                        <input type="number" class="form-control" name="car_number_number" id="car_number_number" value="{{ Common::zeroToSpaceForContract($app_list->entry_contract_name, $app_list->car_number) }}" placeholder="例：1" style="text-align:right" required>
                    ...
                    <div class="col-6 col-md-6 col-lg-3 mt-3">
                        ...
                        <input type="number" class="form-control" name="deposit_fee" id="deposit_fee" value="{{ Common::zeroToSpaceForContract($app_list->entry_contract_name, $app_list->deposit_fee) }}" placeholder="例：1000000" style="text-align:right" required>
                    ...
                    <div class="col-6 col-md-6 col-lg-3 mt-3">
                        ...
                        <input type="number" class="form-control" name="refund_fee" id="refund_fee" value="{{ Common::zeroToSpaceForContract($app_list->entry_contract_name, $app_list->refund_fee) }}" placeholder="例：1000000" style="text-align:right" required>
                    ...
                    <div class="col-6 col-md-6 col-lg-3 mt-3">
                        ...
                        <input type="number" class="form-control" name="security_fee" id="security_fee" value="{{ Common::zeroToSpaceForContract($app_list->entry_contract_name, $app_list->security_fee) }}" placeholder="例：1000000" style="text-align:right" required>
                    ...
                    <div class="col-6 col-md-6 col-lg-3 mt-3">
                        ...
                        <input type="number" class="form-control" name="key_fee" id="key_fee" value="{{ Common::zeroToSpaceForContract($app_list->entry_contract_name, $app_list->key_fee) }}" placeholder="例：1000000" style="text-align:right" required>
                    ...
                    <div class="col-6 col-md-6 col-lg-3 mt-3">
                        ...
                        <input type="number" class="form-control fee_text" name="rent_fee" id="rent_fee" value="{{ Common::zeroToSpaceForContract($app_list->entry_contract_name, $app_list->rent_fee) }}" placeholder="例：100000" style="text-align:right" required>
                    ...
                    <div class="col-6 col-md-6 col-lg-3 mt-3">
                        ...
                        <input type="number" class="form-control fee_text" name="service_fee" id="service_fee" value="{{ Common::zeroToSpaceForContract($app_list->entry_contract_name, $app_list->service_fee) }}" placeholder="例：10000" style="text-align:right" required>
                    ...
                    <div class="col-6 col-md-6 col-lg-3 mt-3">
                        ...
                        <input type="number" class="form-control fee_text" name="water_fee" id="water_fee" value="{{ Common::zeroToSpaceForContract($app_list->entry_contract_name, $app_list->water_fee) }}" placeholder="例：2000" style="text-align:right" required>
                    ...
                    <div class="col-6 col-md-6 col-lg-3 mt-3">
                        ...
                        <input type="number" class="form-control fee_text" name="ohter_fee" id="ohter_fee" value="{{ Common::zeroToSpaceForContract($app_list->entry_contract_name, $app_list->ohter_fee) }}" placeholder="例：1000" style="text-align:right" required>
                    ...
                    <div class="col-6 col-md-6 col-lg-3 mt-3">
                        ...
                        <input type="number" disabled="disabled" class="form-control" name="total_fee" id="total_fee" value="{{ Common::zeroToSpaceForContract($app_list->entry_contract_name, $app_list->total_fee) }}" placeholder="例：113000" style="text-align:right" required>
                        <div class="trade-tab invalid-feedback" id ="total_fee_error">
                            月額賃料は必須です。
                        </div> 
                    </div>
            ...
            <div class="tab-pane fade" id="nav-contract" role="tabpanel" aria-labelledby="nav-contract-tab">
                <div class="row row-cols-2">
                    ...
                    <div class="col-6 col-md-12 col-lg-3 mt-3">
                        ...
                        <input type="number" class="form-control" name="entry_contract_age" id="entry_contract_age" value="{{ Common::zeroToSpaceForContract($app_list->entry_contract_name, $app_list->entry_contract_age) }}" placeholder="例：30" required>
                    ...
                    <div class="col-6 col-md-12 col-lg-3 mt-3">
                        ...
                        <input type="number" class="form-control" name="entry_contract_business_year" id="entry_contract_business_year" value="{{ Common::zeroToSpaceForContract($app_list->entry_contract_name, $app_list->entry_contract_business_year) }}" style="text-align:right" placeholder="例：10" required>
                    ...
                    <div class="col-6 col-md-12 col-lg-2 mt-3">
                        ...
                        <input type="number" class="form-control" name="entry_contract_income" id="entry_contract_income" value="{{ Common::zeroToSpaceForContract($app_list->entry_contract_name, $app_list->entry_contract_income) }}" style="text-align:right" placeholder="例：3000000" required>
                                        ...
                                        <table class="table table-hover table-condensed">
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th scope="col" id="create_user_mail">電話番号</th>
                                                    <th scope="col" id="create_user_tel">電話番号2</th>
            ...
            <div class="tab-pane fade" id="nav-emergency" role="tabpanel" aria-labelledby="nav-emergency-tab">
                <div class="row row-cols-2">
                    ...
                    <div class="col-6 col-md-12 col-lg-2 mt-3">
                        <label class="label_required mb-2" for="textBox"></label>年齢
                        <input type="number" class="form-control" name="emergency_age" id="emergency_age" value="{{ Common::zeroToSpaceForContract($app_list->entry_contract_name, $app_list->emergency_age) }}" style="text-align:right" placeholder="例：30" required>
            ...
            <div class="tab-pane fade" id="nav-guarantor" role="tabpanel" aria-labelledby="nav-guarantor-tab">
                <div class="row row-cols-2">
                    ...
                    <div class="col-6 col-md-12 col-lg-2 mt-3">
                        <label class="label_required mb-2" for="textBox"></label>年齢
                        <input type="number" class="form-control guarantor_disable_flag" name="guarantor_age" id="guarantor_age" value="{{ Common::zeroToSpaceForContract($app_list->entry_contract_name, $app_list->guarantor_age) }}" style="text-align:right" placeholder="例：40">
                    ...
                    <div class="col-6 col-md-12 col-lg-3 mt-3">
                        <label class="label_required mb-2" for="textBox"></label>勤続年数
                        <input type="number" class="form-control guarantor_disable_flag" name="guarantor_business_years" id="guarantor_business_years" value="{{ Common::zeroToSpaceForContract($app_list->entry_contract_name, $app_list->guarantor_business_years) }}" style="text-align:right" placeholder="例：50">
                    ...
                    <div class="col-6 col-md-12 col-lg-3 mt-3">
                        <label class="label_required mb-2" for="textBox"></label>年収
                        <input type="number" class="form-control guarantor_disable_flag" name="guarantor_income" id="guarantor_income" value="{{ Common::zeroToSpaceForContract($app_list->entry_contract_name, $app_list->guarantor_income) }}" style="text-align:right" placeholder="例：50000000">
