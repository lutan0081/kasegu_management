...
<html lang="ja">
    <head>
        ...
        <!-- siteUse -->
        <link rel="stylesheet" href="{{ asset('front/css/front_siteUse.css') }}">
    </head>
    ...
    <body>
        ...
        <div class="container pt-1 pb-5">
            <div class="row row-cols-1">
                <!-- 表題 -->
                <div class="title fadeLeftTrigger">
                    <h2><span>サイト利用規約</span></h2>
                </div>
                ...
                <div class="box fadeUpTrigger">
                    ...
                    ⑮他のユーザーに成りすます行為<br>
                    <br>
                    <strong>第6条 (本サービスの提供の停止等)</strong><br>
                    ...
                    <br>
                    <strong>第7条 (利用制限および登録抹消)</strong><br>
                    ...
                    <br>
                    <strong>第9条 (保証の否認および免責事項)</strong><br>
                    ...
                    <br>
                    <strong>第10条 (サービス内容の変更等)</strong><br>
                    当社は，ユーザーに通知することなく，本サービスの内容を変更しまたは本サービスの提供を中止することができるものとし，これによってユーザーに生じた損害について一切の責任を負いません。
                    <br><br>
                    <strong>第11条 (利用規約の変更)</strong><br>
                    当社は，必要と判断した場合には，ユーザーに通知することなくいつでも本規約を変更することができるものとします。なお，本規約の変更後，本サービスの利用を開始した場合には，当該ユーザーは変更後の規約に同意したものとみなします。
                    <br><br>
                    <strong>第12条 (個人情報の取扱い)</strong><br>
                    当社は，本サービスの利用によって取得する個人情報については，当社「プライバシーポリシー」に従い適切に取り扱うものとします。
                    <br><br>
                    <strong>第13条 (通知または連絡)</strong><br>
                    ユーザーと当社との間の通知または連絡は，当社の定める方法によって行うものとします。当社は,ユーザーから,当社が別途定める方式に従った変更届け出がない限り,現在登録されている連絡先が有効なものとみなして当該連絡先へ通知または連絡を行い,これらは,発信時にユーザーへ到達したものとみなします。
                    <br><br>
                    <strong>第14条 (権利義務の譲渡の禁止)</strong><br>
                    ユーザーは，当社の書面による事前の承諾なく，利用契約上の地位または本規約に基づく権利もしくは義務を第三者に譲渡し，または担保に供することはできません。
                    <br><br>
                    <strong>第15条 (準拠法・裁判管轄)<br></strong>
