...
// 申込管理(申込URL再発行:モーダル開いたときにURL生成)
Route::post('adminAppModalInit', 'Admin\App\AdminAppController@adminAppModalInit')->middleware("kasegu_auth");

// 申込管理(削除)
Route::post('adminAppDeleteEntry', 'Admin\App\AdminAppController@adminAppDeleteEntry')->middleware("kasegu_auth");

// 申込管理(同居人ダブルクリック)
Route::post('adminAppHouseMateInit', 'Admin\App\AdminAppController@adminAppHouseMateInit')->middleware("kasegu_auth");

// 申込管理(画像個別削除)
Route::post('adminDeleteEntryImgDetail', 'Admin\App\AdminAppController@adminDeleteEntryImgDetail')->middleware("kasegu_auth");

// 申込管理(契約に進める)
Route::post('adminAppNextStageEntry', 'Admin\App\AdminAppController@adminAppNextStageEntry')->middleware("kasegu_auth");
 ...
 */
// 契約一覧(表示)
Route::any('adminContractInit', 'Admin\Contract\AdminContractController@adminContractInit')->middleware("kasegu_auth");

// 契約詳細(新規表示)
Route::get('adminContractNewInit', 'Admin\Contract\AdminContractController@adminContractNewInit')->middleware("kasegu_auth");
...
// 契約詳細(登録)
Route::post('adminContractEditEntry', 'Admin\Contract\AdminContractController@adminContractEditEntry')->middleware("kasegu_auth");

// 契約詳細(削除)
Route::post('adminContractDeleteEntry', 'Admin\Contract\AdminContractController@adminContractDeleteEntry')->middleware("kasegu_auth");

// 銀行一覧取得(モーダル初期表示・検索)
Route::post('adminSearchBank', 'Admin\Contract\AdminContractController@adminSearchBank')->middleware("kasegu_auth");

// 同居人(登録)
Route::post('adminContractHouseMateEditEntry', 'Admin\Contract\AdminContractController@adminContractHouseMateEditEntry')->middleware("kasegu_auth");

// 同居人(編集表示)
Route::post('adminContractHouseMateEditInit', 'Admin\Contract\AdminContractController@adminContractHouseMateEditInit')->middleware("kasegu_auth");

// 同居人(削除)
Route::post('adminContractHouseMateDeleteEntry', 'Admin\Contract\AdminContractController@adminContractHouseMateDeleteEntry')->middleware("kasegu_auth");
