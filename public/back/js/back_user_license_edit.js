$(function(){
    ...
    $("#btn_edit").on('click', function(e) {
        ...
        // 宅建取引氏名
        let user_license_name = $("#user_license_name").val();

        // フリガナ
        let user_license_ruby = $("#user_license_ruby").val();
        ...
        sendData.append('user_license_ruby', user_license_ruby);
            ...
            if(data.status == true){
                ...
                swal(options)
                    ...
                    if (val) {
                        ...
                        location.href = 'backUserLicenseInit';
                    };
                });
        ...
        swal(options)
            ...
            if (val == "OK") {
                ...
                $.ajax({
                    ...
                    type: 'post',
                    url: 'backUserLicenseDeleteEntry',
                    dataType: 'json',
                    data: sendData,
