        ...
        swal(options)
            ...
            if (val == "ok") {
                ...
                $.ajax({
                    ...
                    type: 'post',
                    url: 'frontAppHouseMateDeleteEntry',
                    dataType: 'json',
                    data: sendData,
