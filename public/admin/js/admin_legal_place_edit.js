$(function(){
    ...
    $(".btn_zip").on('click', function(e) {
        ...
        let post_number = $('#legal_place_post_number').val();
        ...
        // 接続が出来た場合の処理
            ...
            if(data.results !== null){
                ...
                console.log(address);
                $('#legal_place_address').val(address);
    ...
    $("#btn_edit").on('click', function(e) {
        ...
        for (let i = 0; i < forms[0].length; i++) {
             ...
             */
            // tel
            if (f_id == 'legal_place_tel') {
                continue;
            }

            // fax
            if (f_id == 'legal_place_fax') {
                continue;
            }

            // id
            if (f_id == 'legal_place_id') {
                continue;
            }
        ...
        // 法務局名
        let legal_place_name = $("#legal_place_name").val();
        ...
        sendData.append('legal_place_name', legal_place_name);
            ...
            if(data.status == true){
                ...
                swal(options)
                    ...
                    if (val) {
                        ...
                        location.href = 'adminConfigLegalPlaceInit';
                    };
                });
